...
from split_function_version.ifc_filter import filter_elements
from split_function_version.ifc_exporter import export_ifc
class IFCSearcher:
    ...
    def create_widgets(self):
        ...
        self.add_category_dropdown(category_frame)  # Erstes Dropdown
